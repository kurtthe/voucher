...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Browse Vouchers Of '<?php echo ucwords($outlet->business_name); ?>'
            <small>Voucher Manager</small>
          </h1>
          <ol class="breadcrumb">
              <li><a href="browse_outlets.php"><i class="fa fa-bars"></i> Browse Outlets</a></li>
              <li><a href="add_voucher.php?id=<?php echo $outlet->id; ?>"><i class="fa fa-plus-square"></i> Add Voucher</a></li>
          </ol>
        </section>
...
//                                        { "mData": "serial_no", "bSearchable": false, "bRegex": false, "bSortable": false },
                        ...
                        "ajax": "../core/datatables/admin_browse_vouchers.php?id="+<?php echo $outlet->id; ?>,
                        "bAutoWidth":false
            });
