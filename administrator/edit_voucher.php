...
if(isset($_POST) && isset($_POST['saveVoucher'])){
    ...
    header("Location:browse_vouchers.php?id=".$outlet_id);
    exit;
    
}

$id = (int)mysqli_real_escape_string($dbHandle, $_GET['id']);
$item_id = (int)mysqli_real_escape_string($dbHandle, $_GET['item_id']);

$sql = "SELECT id,business_name FROM ".TBL_OUTLETS." WHERE id = '".$id."'";
...
if(!$outlet){
    ...
    $flash->warning('Outlet not found.');
    header("Location:browse_outlets.php");
    exit;
    
}

$sql = "SELECT * FROM ".TBL_VOUCHERS." WHERE id = '".$item_id."' AND outlet_id = '".$outlet->id."'";
...
if(!$voucher){
    ...
    header("Location:browse_vouchers.php?id=".$outlet->id);
    exit;
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Edit Voucher Of '<?php echo ucwords($outlet->business_name); ?>'
            <small>Voucher Manager</small>
          </h1>
          <ol class="breadcrumb">
              <li><a href="browse_vouchers.php?id=<?php echo $outlet->id; ?>"><i class="fa fa-bars"></i> Browse Vouchers</a></li>
          </ol>  
        </section>
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="months_of_expiration" class="form-control" style="width:25%;">
                                <option value="1" <?php if($voucher->months_of_expiration == 1) echo 'selected'; ?>>1 Month</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="voucher_status" class="form-control" style="width:25%;">
