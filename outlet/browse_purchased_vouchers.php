...
/*if(isset($_POST['redem']) && $_POST['redem'] == 'yes'){
...
$(function () {
    ...
    $(document).ajaxComplete(function() {
        ...
        /*$(".iCheck-helper").on('click', function() {
            ...
            $.ajax({
                    type   : "POST",
                    url    : "browse_purchased_vouchers.php",
                    data   : {'redem':'yes','sold_voucher_id':sold_voucher_id, 'redeem':redeem},
    ...
    //                                        { "mData": "serial_no", "bSearchable": false, "bRegex": false, "bSortable": false },
                ...
                "saveState": true,          
                "ajax": "../core/datatables/outlet_browse_purchased_vouchers.php?id="+<?php echo $_SESSION['OUTLET']['Id']; ?>,
                "bAutoWidth":false,
                dom: 'T<"clear">lfrtip',
                deferRender: true,
                tableTools: {
